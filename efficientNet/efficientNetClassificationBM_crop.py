...
class CFG:
  ...
  test_path='/ddsmDataset/classification_BM_DDSM_crop/val'
...
model.classifier = nn.Sequential(
    nn.Linear(in_features=1792, out_features=2), #1792 is the orginal in_features
    ...
    def fit(self,model,trainloader,validloader,epochs):
        ...
        for i in range(epochs):
            ...
            if avg_valid_acc > valid_max_acc:
                ...
                torch.save(model.state_dict(),'/ddsmDataset/classification_BM_DDSM_crop/ColabDDSMModel_bestAcc_BM.pt')
...
model.load_state_dict(torch.load('/ddsmDataset/classification_BM_DDSM_crop/ColabDDSMModel_bestAcc_BM.pt'))
model.eval()
