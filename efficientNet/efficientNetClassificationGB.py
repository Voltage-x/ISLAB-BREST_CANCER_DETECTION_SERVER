...
class CFG:
  ...
  #TRAIN = "train"
  #VAL = "val"
  train_path='/ddsmDataset/classification3/train'
  validate_path='/ddsmDataset/classification3/val'
  test_path='/ddsmDataset/classification3/val'
    ...
    def fit(self,model,trainloader,validloader,epochs):
        ...
        for i in range(epochs):
            ...
            if avg_valid_acc > valid_max_acc:
                ...
                torch.save(model.state_dict(),'/ddsmDataset/classification3/ColabDDSMModel_bestAcc_classGB.pt')
...
model.load_state_dict(torch.load('/ddsmDataset/classification3/ColabDDSMModel_bestAcc_classGB.pt'))
model.eval()
