...
class CFG:
    ...
    #TRAIN = "train"
    #VAL = "val"
    train_path = '/ddsmDataset/classification_BM_INBreast/train'
    validate_path = '/ddsmDataset/classification_BM_INBreast/val'
    test_path = '/ddsmDataset/classification_BM_INBreast/val'
    ...
    def fit(self, model, trainloader, validloader, epochs):
        ...
        for i in range(epochs):
            ...
            if avg_valid_acc > valid_max_acc:
                ...
                torch.save(
                    model.state_dict(), '/ddsmDataset/classification_BM_INBreast/ColabDDSMModel_bestAcc_BM.pt')
...
model.load_state_dict(torch.load(
    '/ddsmDataset/classification_BM_INBreast/ColabDDSMModel_bestAcc_BM.pt'))
model.eval()
