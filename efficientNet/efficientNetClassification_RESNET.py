...
class CFG:
  ...
  # resnext101_32x8d
  model_name = 'resnext101_32x8d'    # Model name (we are going to import model from timm)
  img_size = 320                          # Resize all the images to be 224 by 224
...
model.fc = nn.Sequential(
    nn.Linear(in_features=2048, out_features=2), #1792 is the orginal in_features
    ...
    def fit(self,model,trainloader,validloader,epochs):
        ...
        for i in range(epochs):
            ...
            if avg_valid_acc > valid_max_acc:
                ...
                torch.save(model.state_dict(),'/ddsmDataset/classification_BM_INBreast/ColabDDSMModel_bestAcc_BM_res.pt')
...
model.load_state_dict(torch.load('/ddsmDataset/classification_BM_INBreast/ColabDDSMModel_bestAcc_BM_res.pt'))
model.eval()
