...
model.classifier = nn.Sequential(
    ...
    nn.Linear(in_features=1792, out_features=3),
    ...
    def fit(self, model, trainloader, validloader, epochs):
        ...
        for i in range(epochs):
            ...
            if avg_valid_acc > valid_max_acc:
                ...
                torch.save(
                    model.state_dict(), '/ddsmDataset/classification_BGM_DDSM/ColabDDSMModel_bestAcc_class3.pt')
...
model.load_state_dict(torch.load(
    '/ddsmDataset/classification_BGM_DDSM/ColabDDSMModel_bestAcc_class3.pt'))
model.eval()
