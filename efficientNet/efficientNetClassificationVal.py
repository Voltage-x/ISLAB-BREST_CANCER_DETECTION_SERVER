...
class CFG:
    ...
    #TRAIN = "train"
    #VAL = "val"
    train_path = '/ddsmDataset/classification4/train'
    validate_path = '/ddsmDataset/classification4/val'
    ...
    def fit(self, model, trainloader, validloader, epochs):
        ...
        for i in range(epochs):
            ...
            if avg_valid_acc > valid_max_acc:
                ...
                torch.save(
                    model.state_dict(), '/ddsmDataset/classification4/ColabDDSMModel_bestAcc_BM.pt')
...
model.load_state_dict(torch.load(
    '/ddsmDataset/classification4/ColabDDSMModel_bestAcc_BM.pt'))
model.eval()
...
for i, testEle in enumerate(testset):
    ...
    resultText.write(str(resultConfid[0]) + " " + str(resultConfid[1]) + " " + str(resultConfid[2]))
    resultText.close()
